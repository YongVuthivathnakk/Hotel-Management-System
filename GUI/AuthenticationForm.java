...
public class AuthenticationForm implements ActionListener{
    ...
    public AuthenticationForm(HashMap<String, String> loginInfoOriginal) {
        ...
        usernameLabel.setFont(new Font("Serif", Font.PLAIN, 24));
        usernameLabel.setBounds(50, 30, 300, 30);
